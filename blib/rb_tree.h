#ifndef BLIB_RB_TREE_H
#define BLIB_RB_TREE_H
...
// rb tree 的迭代器设计
    ...
    template<class T>
    struct rb_tree_iterator_base : public std::iterator<std::bidirectional_iterator_tag, T> {
...
// 参数一代表数据类型，参数二代表键值比较类型
    ...
    private:
        ...
        // get insert pos
        std::pair<base_ptr, bool>
        get_insert_multi_pos(const key_type &key);

        std::pair<std::pair<base_ptr, bool>, bool>
